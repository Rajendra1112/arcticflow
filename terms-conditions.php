...
<section class="terms-conditions-page-content-section section-padding">
    <div class="container">
        <div class="inner-page-heading-1">
            Terms & Conditions
        </div>
        <div class="document-content">
            ...
            <ul>
                ...
                <li>
                    <p><strong>"Terms and Conditions"</strong> (also referred as "Terms" or "Terms of Use") mean these
                        Terms and Conditions that form the entire agreement between You and the Company regarding the
                        use of the Service. This Terms and Conditions Agreement was generated by <a
                            href="https://www.termsfeed.com/blog/sample-terms-and-conditions-template/">TermsFeed Terms
                            and Conditions Template</a>.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>"Website"</strong> refers to [___WEBSITE_NAME___], accessible from [___WEBSITE_URL___]
                    </p>
                </li>
                <li>
            ...
            <p>The Company reserves the right, but not the obligation, to, in its sole discretion, determine whether or
                ...
                Company can also limit or revoke the use of the Service if You post such objectionable Content.<br />
                As the Company cannot control all content posted by users and/or third parties on the Service, you agree
            ...
            <p>Although regular backups of Content are performed, the Company does not guarantee there will be no loss
            ...
            <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work
                ...
                ([___COPYRIGHT_AGENT_CONTACT_EMAIL___]) and include in Your notice a detailed description of the alleged
                infringement.</p>
